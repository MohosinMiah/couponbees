...
<div class="page-header">
    ...
    <h1><i class="bi bi-award me-2 text-primary"></i>Add New Sponsor</h1>
</div>
        ...
        <form action="{{ route('admin.sponsors.store') }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                   value="{{ old('name') }}" placeholder="e.g. iFunds" required>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="svg" id="svgInput" class="form-control font-monospace small @error('svg') is-invalid @enderror"
                                      rows="8" placeholder="<svg xmlns=&quot;http://www.w3.org/2000/svg&quot; ...>...</svg>" required>{{ old('svg') }}</textarea>
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary px-4">
                    <i class="bi bi-check-lg me-1"></i>Create Sponsor
                </button>
