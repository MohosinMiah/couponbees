...
<div class="page-header">
    ...
    <h1><i class="bi bi-tags me-2 text-primary"></i>Add New Category</h1>
</div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="slug" id="categorySlug"
                                       ...
                                       value="{{ old('slug') }}" placeholder="electronics">
                            </div>
    ...
    <div class="col-lg-4">
        <div class="card border-0 bg-light">
            <div class="card-body small text-muted">
                ...
                <ul class="ps-3 mb-0">
                    <li class="mb-1">The <strong>slug</strong> is auto-generated from the name if left blank.</li>
